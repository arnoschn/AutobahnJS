...
var assert	= function(cond, text, raiseError){
	if( cond )	return;
	if( assert.useDebugger || (typeof AUTOBAHN_DEBUG!=="undefined" && AUTOBAHN_DEBUG))	debugger;
...
function inherits(obj) {
    var newObj = function() { obj.apply(this,arguments);};
    newObj.prototype = deepCopy(obj.prototype);
    return newObj;
}
